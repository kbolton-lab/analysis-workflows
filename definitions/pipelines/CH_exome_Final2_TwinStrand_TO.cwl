...
steps:
    ...
    Mutect_isec_complement_gnomAD:
        ...
        in:
            ...
            output_vcf_name: 
                valueFrom: "mutect.gnomAD_AF_filter.vcf"
            output_type: 
                default: "z"
        doc: "both input files should be bgzipped and indexed"
        out:
            [complement_vcf]
    Mutect_isec_complement_gnomAD_index:
    ...
    mutect_annotate_variants:
        run: ../tools/vep_3g.cwl
        in:
            vcf: Mutect_isec_complement_gnomAD_index/indexed_vcf
    ...
    varscan:
        ...
        out:
            [unfiltered_vcf, filtered_vcf]
    # no PoN
    Varscan_isec_complement_gnomAD:
        run: ../tools/bcftools_isec_complement.cwl
        in:
            vcf: varscan/unfiltered_vcf
            exclude_vcf: gnomAD_exclude_vcf
            output_vcf_name: 
                valueFrom: "vardict.gnomAD_AF_filter.vcf"
            output_type: 
                default: "z"
        doc: "both input files should be bgzipped and indexed"
        out:
            [complement_vcf]
    Varscan_isec_complement_gnomAD_index:
        run: ../tools/index_vcf.cwl
        in:
            vcf: Varscan_isec_complement_gnomAD/complement_vcf
        out:
            [indexed_vcf]
    varscan_annotate_variants:
        run: ../tools/vep_3g.cwl
        in:
            vcf: Varscan_isec_complement_gnomAD_index/indexed_vcf
            cache_dir: vep_cache_dir
            ensembl_assembly: vep_ensembl_assembly
            ensembl_version: vep_ensembl_version
            ensembl_species: vep_ensembl_species
    ...
    final_annotation:
        ...
        in:
            mutect_vcf: mutect_annotate_variants/annotated_vcf
            varscan_vcf: varscan_annotate_variants/annotated_vcf
            vardict_vcf: vardict_annotate_variants/annotated_vcf
            pindel_vcf: pindel_annotate_variants/annotated_vcf
            sample_name: tumor_sample_name
